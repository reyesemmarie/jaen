...
<body>
		...
		<div id="bg">
			<div id="outer">
				...
				<div id="main">
					...
					<div id="content">
						...
						<div id="box2">
							<h3>
								Patakaran at Tuntunin ng Paaralan
							</h3>
							<ul class="imageList">
								<li class="first">
									 <span>Igalang mo ang mga guro, mga bisita at lahat ng mga nanunungkulan sa paaralan.<br />
											Kilalanin ang kanilang mga katungkulan at lagi silang tawagin nang may paggalang,<br />
											tulad ng Madam o Sir at gumamit ng po at opo kung nakikipag-usap sa kanila
									 </span>
								</li>
								<li>
			...
			<div id="copyright">
				&copy; JaenHigh | Modify by <a href="#"> Mariel Macaso</a>
			</div>
		</div>

...
$sql="SELECT * FROM student WHERE username ='$myusername' and  password ='$mypassword'";//select if there is existing database
...
else
{
	...
	window.location='index.php'; //re-direct to the main page
	</script>
	<?php

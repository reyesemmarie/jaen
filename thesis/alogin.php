...
$sql="SELECT * FROM admin WHERE username ='$myusername' and  password ='$mypassword'";//select if there is existing database
...
else
{
	...
	window.location='adminlog.php'; //re-direct to the main page
	</script>
	<?php
